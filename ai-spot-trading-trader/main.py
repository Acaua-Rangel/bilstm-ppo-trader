...
async def get_sleep_time_until_next_interval(minutes_interval=15):
    """
    Calcula quantos segundos faltam para o fechamento do próximo candle de 15 minutos.
...
async def main_loop():
    ...
    logger.info("Sistema Online e Integrado. Aguardando o ciclo de 15 minutos...")

    try:
        while True:
            sleep_sec = await get_sleep_time_until_next_interval(15)
            ...
            logger.info(f"Sinal do Modelo: {global_action} | Preço Atual (BTC/FDUSD): {current_price}")
